...
`)}},Fo=ho,Co=["	",`
`,"\f","\r"," "],Ao=new Fo(Co),et=Ao,go=/^\\?.$/su,Eo=/^\n *>[ >]*$/u;ko=mo;So=new Set(["heading","tableCell","link","wikiLink"]),tt=new Set("!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~");Po=(u,e)=>{for(let t of e)u=su(0,u,t,encodeURIComponent(t));return u};zo={features:{experimental_frontMatterSupport:{massageAstNode:!0,embed:!0,print:!0}},preprocess:ko,print:No,embed:Ki,massageAstNode:Vi,hasPrettierIgnore:jo,insertPragma:Mi,getVisitorKeys:ro},$o=zo,Uo=[{name:"Markdown",type:"prose",aceMode:"markdown",extensions:[".md",".livemd",".markdown",".mdown",".mdwn",".mkd",".mkdn",".mkdown",".ronn",".scd",".workbook"],filenames:["contents.lr","README"],tmScope:"text.md",aliases:["md","pandoc"],codemirrorMode:"gfm",codemirrorMimeType:"text/x-gfm",wrap:!0,parsers:["markdown"],vscodeLanguageIds:["markdown"],linguistLanguageId:222},{name:"MDX",type:"prose",aceMode:"markdown",extensions:[".mdx"],filenames:[],tmScope:"text.md",aliases:["md","pandoc"],codemirrorMode:"gfm",codemirrorMimeType:"text/x-gfm",wrap:!0,parsers:["mdx"],vscodeLanguageIds:["mdx"],linguistLanguageId:222}],Dt={bracketSpacing:{category:"Common",type:"boolean",default:!0,description:"Print spaces between brackets.",oppositeDescription:"Do not print spaces between brackets."},objectWrap:{category:"Common",type:"choice",default:"preserve",description:"How to wrap object literals.",choices:[{value:"preserve",description:"Keep as multi-line, if there is a newline between the opening brace and first property."},{value:"collapse",description:"Fit to a single line when possible."}]},singleQuote:{category:"Common",type:"boolean",default:!1,description:"Use single quotes instead of double quotes."},proseWrap:{category:"Common",type:"choice",default:"preserve",description:"How to wrap prose.",choices:[{value:"always",description:"Wrap prose if it exceeds the print width."},{value:"never",description:"Do not wrap prose."},{value:"preserve",description:"Wrap prose as-is."}]},bracketSameLine:{category:"Common",type:"boolean",default:!1,description:"Put > of opening tags on the last line instead of on a new line."},singleAttributePerLine:{category:"Common",type:"boolean",default:!1,description:"Enforce single attribute per line in HTML, Vue and JSX."}},Mo={proseWrap:Dt.proseWrap,singleQuote:Dt.singleQuote},_o=Mo,Mt={};ct(Mt,{markdown:()=>lt,mdx:()=>s2,remark:()=>lt});Vo=$u(tr(),1),Ho=$u(ir(),1),Wo=$u(fn(),1),Go=$u(bn(),1),Jo=/^import\s/u,Yo=/^export\s/u,Ko="[a-z][a-z0-9]*(\\.[a-z][a-z0-9]*)*|",Qo=/<!---->|<!---?[^>-](?:-?[^-])*-->/u,Zo=/^\{\s*\/\*(.*)\*\/\s*\}/u,Xo=u=>Jo.test(u),_t=u=>Yo.test(u),Vt=u=>Xo(u)||_t(u),Ue=(u,e)=>{let t=e.indexOf(`

`),r=t===-1?e:e.slice(0,t);if(Vt(r))return u(r)({type:_t(r)?"export":"import",value:r})};Ue.notInBlock=!0;Ue.locator=u=>Vt(u)?-1:1;Ht=(u,e)=>{let t=Zo.exec(e);if(t)return u(t[0])({type:"esComment",value:t[1].trim()})};Ht.locator=(u,e)=>u.indexOf("{",e);u2=function(){let{Parser:u}=this,{blockTokenizers:e,blockMethods:t,inlineTokenizers:r,inlineMethods:n}=u.prototype;e.esSyntax=Ue,r.esComment=Ht,t.splice(t.indexOf("paragraph"),0,"esSyntax"),n.splice(n.indexOf("text"),0,"esComment")},e2=function(){let u=this.Parser.prototype;u.blockMethods=["frontMatter",...u.blockMethods],u.blockTokenizers.frontMatter=e;function e(t,r){let{frontMatter:n}=xe(r);if(n)return t(n.raw)({...n,type:"frontMatter"})}e.onlyAtStart=!0},t2=e2;n2=r2,i2=function(){let u=this.Parser.prototype,e=u.inlineMethods;e.splice(e.indexOf("text"),0,"liquid"),u.inlineTokenizers.liquid=t;function t(r,n){let i=n.match(/^(\{%.*?%\}|\{\{.*?\}\})/su);if(i)return r(i[0])({type:"liquidNode",value:i[0]})}t.locator=function(r,n){return r.indexOf("{",n)}},o2=i2,a2=function(){let u="wikiLink",e=/^\[\[(?<linkContents>.+?)\]\]/su,t=this.Parser.prototype,r=t.inlineMethods;r.splice(r.indexOf("link"),0,u),t.inlineTokenizers.wikiLink=n;function n(i,a){let o=e.exec(a);if(o){let D=o.groups.linkContents.trim();return i(o[0])({type:u,value:D})}}n.locator=function(i,a){return i.indexOf("[",a)}},D2=a2;Gt={astFormat:"mdast",hasPragma:Nt,hasIgnorePragma:Ui,locStart:de,locEnd:Ce},lt={...Gt,parse:Wt({isMDX:!1})},s2={...Gt,parse:Wt({isMDX:!0})},l2={mdast:$o}});c2();export{yn as default,Uo as languages,_o as options,Mt as parsers,l2 as printers};
